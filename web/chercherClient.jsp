                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <small>/Client/Malade</small>
                                        <span class="pull-right"><a href="" class="btn btn-success"><i class="fa fa-user-plus"></i> Nouveau</a></span>
                                    </div>
                                       ...
                                       <div class="table-responsive" id="table-liste">
                                        <table class="table table-borderless customers-list">
                                            <thead>
                                                ...
                                                <th>Post-Nom</th>
                                                <th>Prénom</th>
                                                <th>Choisir <i class="fa fa-hand-o-down"></i></th>
                                            </thead>
                                            <tbody>
